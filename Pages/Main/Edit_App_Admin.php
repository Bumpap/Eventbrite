...
<table class="table">
    ...
    ?>  
        ...
        <h1> Edit Event:  <?php echo $row['Name'] ?></h1>
        ...
        <tr>
                ...
                <td><select class="form-select" name="Type_App" aria-label="Default select example" required>
                    <option value="<?php echo $row['Type_App'] ?>" disabled><?php echo $row['Type_App'] ?></option>
                        <?php
            ...
            <tr>
                ...
                <td><select class="form-select" name="Status" aria-label="Default select example" required>
                        <option value="<?php echo $row['Status'] ?>" disabled><?php echo $row['Status'] ?></option>

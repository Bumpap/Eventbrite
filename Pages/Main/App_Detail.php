...
<ul class="product-list" style="display: flex;
    ...
    ?>
        <div class="event-hero__background"><img class="h-100 w-100" src="<?php echo $row_pro['Icon'] ?>"></div>
        <div class="event-detail" id="appprofile">
            ...
            <p ><b>Paid:</b> <?php echo $row_pro['Paid'] ?></p>
            <p><b>Type:</b> <?php echo $row_pro['Type_App'] ?></p>
            <p> <b>Describe:</b> <?php echo $row_pro['Describe_App'] ?></p>
            
            <br>
            
            <p class="develop"><b>Develop:</b> <?php echo $row_pro['Develop'] ?></p>
            <p class="follower">6.6k followers</p>
            <br>
            <?php
            if (isset($_SESSION['Login'])) {

...
?>
<h3 style="margin-top: 20px; margin-left: 40px; font-weight: bold; color: blue;">Manage Application</h3>
...
<?php while ($row_pro = mysqli_fetch_array($query_detail)) {?>
        <tr>
            ...
            <td> <?php echo $row_pro['Develop']; ?></td>
            <td> <?php echo $row_pro['Paid']; ?></td>
            <td> <?php echo $row_pro['Status']; ?></td>
